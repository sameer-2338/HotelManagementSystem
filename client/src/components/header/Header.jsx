  ...
  return (
    <div className="header">
        <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
            ...
            { type !== "list" &&
            <>
            <h1 className="headerTitle">A lifetime of discounts? Just like a dream</h1>
            <p className="headerDesc">Full Stack JavaScript Term Project based on <strong>MERN</strong> Stack</p>
            <p><strong>Group 11:</strong> Gagan, Parm, Harpreet, Chetna</p>
